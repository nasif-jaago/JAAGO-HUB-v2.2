...
--   2. organization_branches (Branch Locations)
--   3. organization_policies (Policy Documents & Attachments)
--   4. designations (Designations & Grades)
--   5. departments (Department Hierarchy)
--   6. projects (Projects & Assignments)
--   7. teams (Teams)
--   8. team_members (Team Member Associations)
--   9. insurance_categories (Insurance Info & Premium Categories)
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.organization_policies (
    ...
    organization_id TEXT REFERENCES public.organizations(id) ON DELETE CASCADE,
    title TEXT NOT NULL,
    category TEXT DEFAULT 'GENERAL', -- GENERAL, LEAVE, ATTENDANCE, CODE OF CONDUCT, TRAVEL, EXPENSES, OTHER
...
-- Seed Branches for JAAGO Foundation
...
-- Seed Policies for JAAGO Foundation
