...
function PurchaseRequisitionContent() {
  ...
  const handleOpenNewRequisition = () => {
    router.push('/requests/purchase/new');
  };
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto text-foreground">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-border">
        <div>
          <div className="flex items-center space-x-2 text-xs font-bold text-muted-foreground">
            ...
            <span>&gt;</span>
            <span className="text-foreground">Purchase Requisitions</span>
          </div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Procurement requisitions, institutional supplies, and item approval workflows.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <a
            href="https://jaagohub.jaago.com.bd/?view=approvals"
            target="_blank"
            ...
            title="Open JAAGO Hub Purchase Requisition Log History"
          >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search PR No, title, dept..."
              value={searchQuery}
      ...
      {/* ═══════════════════════════════════════════════════════════════════ */}
      {/* 4. PURCHASE REQUISITION REGISTER / LOG TABLE                        */}
      {/* ═══════════════════════════════════════════════════════════════════ */}
      <div className="border border-border rounded-2xl bg-card overflow-hidden shadow-sm">
        ...
        {loading ? (
          <div className="p-12 text-center text-xs text-muted-foreground">
            Loading purchase requisitions from Supabase...
          </div>
          ...
          <div className="py-16 px-4 text-center flex flex-col items-center justify-center space-y-3">
            ...
            <p className="text-xs text-muted-foreground max-w-sm">
              Click the &quot;NEW REQUISITION&quot; button above to create and submit your first purchase requisition.
            </p>
            <button
              onClick={handleOpenNewRequisition}
