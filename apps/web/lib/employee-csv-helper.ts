...
export const EMPLOYEE_CSV_COLUMNS: CSVColumnDefinition[] = [
  ...
  { header: 'Official Phone Numbers / Personal Phone', key: 'workMobile', aliases: ['official_phone_numbers_personal_phone', 'official phone numbers / personal phone', 'official phone number / personal phone', 'official phone numbers/personal phone', 'official phone number/personal phone', 'official_phone_number', 'official phone number', 'official phone', 'official_phone', 'work_mobile', 'work mobile', 'phone', 'mobile', 'work_phone', 'mobile_phone', 'mobile phone'], defaultValue: '' },
  ...
  { header: 'Routing Number', key: 'bankRoutingNumber', aliases: ['bank_routing_number', 'routing_number', 'routing number', 'routing_no'], defaultValue: '' },
  { header: 'SWIFT Code', key: 'bankSwiftCode', aliases: ['bank_swift_code', 'swift_code', 'swift code', 'swift', 'bic'], defaultValue: '' },
  ...
  { header: 'Confirmation Date', key: 'confirmationDate', aliases: ['confirmation_date', 'confirmation date', 'confirmed_date', 'permanent_date', 'date_of_confirmation'], defaultValue: '' },
  { header: 'Notice Period', key: 'isNoticePeriod', aliases: ['is_notice_period', 'notice_period', 'notice period', 'notice_period_active', 'serving_notice_period', 'notice_status'], type: 'boolean', defaultValue: false },
  { header: 'Date of Resignation', key: 'resignationDate', aliases: ['resignation_date', 'date of resignation', 'resigned_date', 'resignation date', 'date_of_resignation'], defaultValue: '' },
  { header: 'Notice Period Start Date', key: 'noticePeriodStartDate', aliases: ['notice_period_start_date', 'notice period start date', 'notice_start_date', 'notice period start'], defaultValue: '' },
  { header: 'Notice Period End Date', key: 'noticePeriodEndDate', aliases: ['notice_period_end_date', 'notice period end date', 'notice_end_date'], defaultValue: '' },
  { header: 'Notice Period Date', key: 'noticePeriodDate', aliases: ['notice_period_date', 'notice period date', 'last_working_date', 'last working day'], defaultValue: '' },
  ...
  const sampleProfiles: FullEmployeeProfile[] = [
    {
      ...
      bankRoutingNumber: '060261234',
      bankSwiftCode: 'BRACBDDH',
      joiningDate: '2024-08-26',
      contractEndDate: '2027-08-25',
      confirmationDate: '2025-02-26',
...
export function parseComprehensiveEmployeeCSV(csvText: string): {
  ...
  for (let r = 1; r < rows.length; r++) {
    ...
    const completeEmployee: FullEmployeeProfile = {
      ...
      bankRoutingNumber: rowObj.bankRoutingNumber || '',
      bankSwiftCode: rowObj.bankSwiftCode || '',
      ...
      confirmationDate: rowObj.confirmationDate || '',
      isNoticePeriod: Boolean(rowObj.isNoticePeriod),
      resignationDate: rowObj.resignationDate || '',
      noticePeriodStartDate: rowObj.noticePeriodStartDate || '',
      noticePeriodEndDate: rowObj.noticePeriodEndDate || rowObj.noticePeriodDate || '',
      noticePeriodDate: rowObj.noticePeriodEndDate || rowObj.noticePeriodDate || '',
