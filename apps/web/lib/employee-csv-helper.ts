...
export const EMPLOYEE_CSV_COLUMNS: CSVColumnDefinition[] = [
  ...
  { header: 'Employee Name', key: 'name', aliases: ['name', 'full_name', 'employee_name', 'employee name'], defaultValue: '' },
  { header: 'Employee Code', key: 'code', aliases: ['code', 'employee_code', 'employee code', 'emp_code', 'id'], defaultValue: '' },
  { header: 'Designation', key: 'designation', aliases: ['designation', 'job_title', 'position', 'title'], defaultValue: 'Program Officer' },
  { header: 'Status', key: 'status', aliases: ['status', 'employment_status', 'employee_status'], defaultValue: 'Active' },
  { header: 'Organization', key: 'organization', aliases: ['organization', 'company', 'org', 'legal_entity'], defaultValue: 'JAAGO Foundation' },
  { header: 'Branch', key: 'branch', aliases: ['branch', 'office_location', 'branch_name', 'campus'], defaultValue: 'Head Office (Banani)' },
  { header: 'Department', key: 'department', aliases: ['department', 'dept'], defaultValue: 'Program Implementation' },
  { header: 'Project', key: 'project', aliases: ['project', 'project_name'], defaultValue: 'General Operations' },
  { header: 'Team', key: 'team', aliases: ['team', 'squad', 'team_name'], defaultValue: 'Core Development Team' },
  { header: 'Supervisor', key: 'supervisor', aliases: ['supervisor', 'reporting_to', 'line_manager'], defaultValue: '' },
  { header: 'Secondary Supervisor', key: 'secondarySupervisor', aliases: ['secondary_supervisor', 'secondary supervisor'], defaultValue: '' },
  { header: 'Work Location', key: 'workLocation', aliases: ['work_location', 'work location', 'location'], defaultValue: 'Banani, Dhaka' },
  { header: 'Working Schedule', key: 'workingSchedule', aliases: ['working_schedule', 'working schedule', 'shift', 'work_schedule'], defaultValue: 'JAAGO HQ (10:00 AM - 06:00 PM)' },
  { header: 'Work Email', key: 'workEmail', aliases: ['work_email', 'work email', 'email', 'office_email'], defaultValue: '' },
  { header: 'Work Mobile', key: 'workMobile', aliases: ['work_mobile', 'work mobile', 'phone', 'mobile', 'work_phone'], defaultValue: '' },
  { header: 'Work Remark', key: 'remark', aliases: ['remark', 'work_remark', 'notes', 'work_notes'], defaultValue: '' },
