...
export const PERMISSION_MODULES: PermissionModuleGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'p24', key: 'hr.employees.delete', name: 'Delete Employee Records (Super Admin Only)', description: 'Hard delete employee records. Exclusively reserved for Super Admin only.', moduleKey: 'hr_employees', category: 'Operations', actionType: 'DELETE', scope: 'GLOBAL' },
  ...
  {
    moduleKey: 'admin_procurement',
    moduleName: 'Admin & Procurement',
    iconName: 'ShoppingBag',
    description: 'Procurement requisitions, purchase orders, RFQs, vendor catalog, assets, inventory, and supplier contracts.',
    permissions: [
      { id: 'p82', key: 'procurement.view', name: 'View Procurement Portal', description: 'Access Admin & Procurement dashboard, POs, and vendor catalog', moduleKey: 'admin_procurement', category: 'Procurement', actionType: 'VIEW', scope: 'GLOBAL' },
      { id: 'p83', key: 'procurement.requests.create', name: 'Submit Purchase / Recruitment Requests', description: 'Create PR, GR, and Recruitment requisitions', moduleKey: 'admin_procurement', category: 'Requisitions', actionType: 'CREATE', scope: 'DEPARTMENT' },
      { id: 'p84', key: 'procurement.requests.approve', name: 'Approve Requisitions', description: 'Authorize requisitions through institutional approval matrix', moduleKey: 'admin_procurement', category: 'Requisitions', actionType: 'APPROVE', scope: 'GLOBAL' },
      { id: 'p85', key: 'procurement.orders.manage', name: 'Manage Purchase Orders & GRN', description: 'Draft, issue, and inspect Purchase Orders and Goods Receipt Notes', moduleKey: 'admin_procurement', category: 'Orders', actionType: 'MANAGE', scope: 'GLOBAL' },
      { id: 'p86', key: 'procurement.vendors.manage', name: 'Manage Vendors & Contracts', description: 'Register vendors, evaluate ratings, and manage supplier contracts', moduleKey: 'admin_procurement', category: 'Vendors', actionType: 'MANAGE', scope: 'GLOBAL' },
      { id: 'p87', key: 'procurement.inventory.manage', name: 'Manage Inventory & Fixed Assets', description: 'Track warehouse inventory, stock adjustments, and fixed assets', moduleKey: 'admin_procurement', category: 'Inventory', actionType: 'MANAGE', scope: 'GLOBAL' },
      { id: 'p88', key: 'procurement.settings.manage', name: 'Manage Procurement Settings', description: 'Configure numbering series, approval tiers, tax rates, and budgets', moduleKey: 'admin_procurement', category: 'Settings', actionType: 'CONFIG', scope: 'GLOBAL' },
    ],
  },
];
...
export const INITIAL_ROLES: RoleItem[] = [
  ...
  },
  {
    ...
    name: 'Procurement & Admin Manager',
    description: 'Full management of requisitions, purchase orders, RFQs, vendor relationships, contracts, and inventory.',
    color: '#F59E0B',
    isSystem: true,
    userCount: 0,
    permissions: [
